  ...
  return (
    <div className='w-full mt-8 px-3'>
      <div className='text-secondaryText p-5 bg-secondaryTransparent rounded-2xl'>
        ...
        <p className='mb-3 w-full flex justify-between'>
          <span className='font-light'>{"Upgrade Stars Price: "}</span>
          <span className='text-foreground'>{"⭐ " + gift.upgradePrice}</span>
        </p>
        <p className='mb-3 w-full flex justify-between'>
          <span className='font-light'>{"Total Stars Price: "}</span>
          <span className='text-foreground'>{"⭐ " + totalStarsPrice}</span>
        </p>
        <p className='mb-3 w-full flex justify-between'>
          <span className='font-light'>{"Total Stars Price in USD: "}</span>
          <span className='text-foreground'>{"$ " + gift.initUsdPrice}</span>
        </p>
        <p className='mb-3 w-full flex justify-between'>
          <span className='font-light'>{"Total Stars Price in TON: "}</span>
