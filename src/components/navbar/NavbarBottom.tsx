...
export default function NavbarBottom() {
    ...
    return (
        <div className="fixed bottom-0 mb-0 w-screen flex justify-center gap-3 pt-2 pb-10 px-3 items-center backdrop-blur-md">
            <div className="w-full lg:w-1/2 flex flex-row justify-between p-3 ">
                <Link
