...
export default function IndexBlock({name, id}: IndexProps) {
    ...
    return (
        <div className="w-full p-3 border border-secondary rounded-lg">
            <div className="w-full flex flex-row justify-between items-center">
                ...
                <Link
                    href={`/tools/index/${id}`}
                    className="px-3 h-8 flex items-center text-sm border border-secondary bg-secondaryTransparent rounded-lg"
                    onClick={() => vibrate()}
                >
                    {'Show Chart ->'}
                </Link>
            </div>
            <div className="w-full mt-3 flex flex-row justify-between items-center border border-secondary bg-secondaryTransparent p-3 rounded-lg">
