...
export default function EditWatchlistItem({
  ...
  return (
    <div className='w-full h-16 p-3 mb-3 bg-secondaryTransparent flex flex-row items-center justify-start rounded-xl'>
      <div className='flex flex-row items-center gap-x-3'>
        <button
          className='p-3 text-red-600 bg-red-600/10 rounded-xl'
          onClick={() => {
            removeGift(giftId);
            vibrate();
          }}>
