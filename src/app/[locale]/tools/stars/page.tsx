  ...
  return (
    <div className='w-full pt-[0px]  pb-24 flex justify-center'>
      <div className='w-full lg:w-11/12 px-3'>
        ...
        <div className='w-full flex flex-col items-center justify-center bg-secondaryTransparent rounded-3xl p-3'>
          ...
          <p className='mt-3 mb-5 w-full text-center text-secondaryText'>
            ...
            . <br /> You can swap any coin from TON blockchain to Telegram Stars
            without KYC
          </p>
